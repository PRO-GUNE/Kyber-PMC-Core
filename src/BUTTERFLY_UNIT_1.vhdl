...
end entity BUTTERFLY_UNIT_1;

architecture Behavioral of BUTTERFLY_UNIT_1 is
    ...
    -- internal signals
    signal mod_u_in, mod_v_in, add_out, sub_out, scalar_in_0 : std_logic_vector(11 downto 0);
...
begin
    ...
    scalar_in_0 <= half when mode(1)='0' else v_in;
    
    mul_u_in <= twiddle when mode="00" else scalar_out_0;
    mul_v_in <= u_in when mode="10" else v_in when mode="00" else reg_sub;
